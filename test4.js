const unclear1 = document.getElementById('anser2');
const unclear3 = document.getElementById('anser1');
const unclear4 = document.getElementById('anser4');
const clear2 = document.getElementById('anser3');
...
clear2.onclick = function() {
    ...
    next.innerText = '次へ';
    next.setAttribute('href','test5.html')
    while (resultArea.firstChild) {
    resultArea.removeChild(resultArea.firstChild);
  }
